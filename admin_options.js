...
rcube_webmail.prototype.admin_options_select = function(list) {
	...
	if (id = list.get_single_selection())
		rcmail.admin_options_timer = window.setTimeout(function(id) { rcmail.admin_options_load(id, 'plugin.admin_options.load', ''); }, 200, id);
}
...
/*rcube_webmail.prototype.admin_toggle_html = function(obj, cbxid, txtid) {
	...
	var sel = rcube_find_object(cbxid);
